...
KOREAN_QUERIES = [
    ...
    "특허출원 OR 특허등록 OR 특허권",
    "상표권 OR 상표분쟁 OR 상표침해",
    "디자인권 OR 디자인보호 OR 디자인등록",
    "특허침해 OR 특허소송 OR 침해금지",
    "직무발명 OR 발명진흥 OR 발명특허",
    "지식재산 정책 OR 산업재산권 OR 지재권",
    "영업비밀 OR 기술유출 OR 기술탈취",
    "AI 특허 OR 인공지능 특허",
    "반도체 특허",
    "바이오 특허 OR 제약 특허 OR 의약품 특허",
    "표준특허 OR SEP OR FRAND",
    "특허 라이선스 OR 기술이전 OR 실시권",
    "부정경쟁행위 OR 트레이드 드레스",
    "특허법원 OR 특허심판원 OR 무효심판",
]

ENGLISH_QUERIES = [
    "patent Korea",
    "Korea intellectual property",
    "trademark dispute Korea",
    "trade secret Korea",
    "patent infringement Samsung LG SK Hynix",
    "standard essential patent FRAND",
    "USPTO patent Korea",
    "WIPO PCT international patent",
    "ITC section 337 Korea",
    "AI patent intellectual property",
]
